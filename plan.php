                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="">
                                        ...
                                        <p><small>Interest: <b><?php echo $row['interest_percentage']."%" ?></b></small>
                                        </p>
                                        <p><small>Over dure Penalty:
                                                <b><?php echo $row['penalty_rate']."%" ?></b></small></p>
                                    </td>
                                    <?php if($_SESSION['login_type'] == 1): ?>
                                    <td class="text-center">
                                        <button class="btn btn-sm btn-primary edit_plan" type="button"
                                            ...
                                            data-interest_percentage="<?php echo $row['interest_percentage'] ?>">Edit</button>
