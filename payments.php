            ...
            <div class="card-header" style="background: #144959; color: white;	">
                <large class="card-title">
                    ...
                    <button class="btn btn-primary btn-sm btn-block col-md-2 float-right" type="button"
                        id="new_payments" style="font-size: 12px; line-height: 21px;"><i class="fa fa-plus"></i> New
                        Payment</button>
                </large>
                ...
                <table class="table table-bordered" id="loan-list">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center" data-label="Penalty">
                                <?php echo number_format($row['penalty_amount'],2) ?>
                            </td>
                            <td class="text-center removeee" data-label="Action">
                                <button class="btn btn-outline-primary btn-sm edit_payment" type="button"
                                    data-id="<?php echo $row['id'] ?>"><i class="fa fa-edit"></i></button>
                                <?php if($_SESSION['login_type'] == 1): ?>

                                <button class="btn btn-outline-danger btn-sm delete_payment" type="button"
