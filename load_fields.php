    ...
    <div class="row">
        ...
        <div class="col-md-5">
            <div class="form-group">
                ...
                <input type="number" name="amount" step="any" min="" class="form-control"
                    style="pointer-events: none; background: #fff;"
                    value="<?php echo isset($amount) ? $amount : ($monthly + $add)  ?>" readonly>
